...
## 実はほとんどの AWS サービスの API 呼び出しには，IAM をつかった認証認可が行われている

もし IAM がなければ AWS サービスの API 呼び出しに対して独自で認証認可の仕組みを行うか，だれでも API を呼び出せて良いようになる
...
例えば S3 のビッグデータを解析するシステムを作成しているケースで考えてみる
...
- S3 のデータを誰でも閲覧できません
- 悪意のある第三者は S3 のデータは改竄できません
- 悪意のある第三者は S3 にマルウェアなどのウィルスをばら撒けません
