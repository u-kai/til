...
# Copilot の有用な利用シーン(個人的感想)1

## システム開発

- 設計が必要で,ある程度規模が大きいものを作成する場合は Copilot が文脈をどんどん読み取っていくので良いサジェストが来る印象
- また，良い設計であるほど GitHub の に存在するパブリックコードと同じような質になるので，良いサジェストを得られやすい印象
- 一般的なアルゴリズムなど，単純なものであればすぐにサジェストしてくれるため，システム特有のコードの設計に時間を割けられるようになる

---

# Copilot の有用な利用シーン(個人的感想)2
...
- サジェストされたコードの内容が頭の中にあるものと一致したものだけを採用すればライセンス違反する可能性は低いと思う
- DDD のようなプログラムの中のデータと現実の世界とをマッピングし，自分らのドメイン知識をプログラム化させるようなものにすればライセンス違反する可能性は低いと思う
- 危ないのが，何も考えずにサジェストを採用したり，コードレビューをしなかったり，サジェストされたコードの説明や挙動が読めないようなものを採用すること

- コードレビューを必須にして，リスクを極小化させれば Copilot を利用していくべしだと思っている
- また，開発するシステムのスコープにもよるかもしれない
