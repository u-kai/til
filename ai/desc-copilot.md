...
- ライセンス違反となり得るコードがサジェストされる可能性が少ないのでは？
  - 今回例は無理やりサジェストさせた
- サジェストされるコードが自分が書きそうなコードであればライセンス違反する可能性は低いのでは？
- 危ないのが，コードレビューをしなかったり，サジェストされたコードの説明ができないようなサジェストを積極的に採用すること

- コードレビューを必須にして，自分たちのコードにしていけばリスクを極小化できるのではないか？
- また，開発するシステムのスコープもリスクに関係してくると思う
  - 社内用か？社外用か？製品か？
- 今後の機能でライセンス違反を防ぐことができる可能性が高い
