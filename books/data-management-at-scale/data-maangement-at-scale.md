...
- 統合は関係する全てのチームやパーティ間での調整が必要になり，サービスに大量のオプション属性がついてしまう
...
- ベストプラクティス、サポート、継続的デリバリーとインテグレーション機能、自動テスト機能、プロビジョニングツール、ETL などのパイプラインツールなどを提供する
- ドメインに依存しない仕組みを構築する
