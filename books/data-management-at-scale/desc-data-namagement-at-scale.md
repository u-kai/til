...
- データ活用基盤は技術観点とデータ基盤がなぜ必要なのかという目的ベースの 2 つが必須ですが今回は技術観点の紹介をします
...
- 大規模データ管理で紹介されていた Scaled Architecture に関する考え方を紹介する
- 今後のデータ活用基盤の構成要素検討に役立てる
...
- 筆者は大企業のデータアーキテクチャ計画を推進した際の経験に基づいている
  ...
  - 直近十年間企業がデータ駆動になるための完璧なソリューションを探し続けていた
