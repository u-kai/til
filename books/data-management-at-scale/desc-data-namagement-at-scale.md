...
RDB などを使い，全てのデータを構造化して統合して保存するソリューションのことで一般的には RDB
...
非構造データなど，ほとんど全てのデータを統合して保存するソリューションのことで一般にオブジェクトストレージ環境
...
- 企業がデータ駆動になるには?
- アジリティ，セキュリティ，コントールが実現できるような形でデータを効率的に流通させるには？
...
- 権威あるアプリケーション
- すべての信頼できるデータが,ある特定のコンテキストで管理されている
...
- データの統合，移動にもなんらかのコンテキストがある
- データ統合時に，上記コンテキストを反映するデータ変更は常に必要になり，つまり新しいアーキテクチャを常に形作ることになる
- もしもコンテキストを反映しないと．．．
...
- ゴールデンソースから生成されるとゴールデンデータセットの流通のみを許可
- データ変更はゴールデンソースでのみ行う
- ゴールデンデータセットだけを提供する
