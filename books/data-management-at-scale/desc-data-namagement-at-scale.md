...
- データ基盤を構築することの難易度やコストは莫大
- 目的ベース(データで何をしたいのか)でデータ基盤を構築することが重要
- 今回はその目的が存在することを前提に，技術的な観点の話を行う
...
結論としてメタデータを集めるところからはじめないかと提言してみたい
データレイヤーを作ってそこを経由させるようにする
このデータレイヤーを利用してくれる仲間を作るのか，Ariba とか自分達が持っているものを使うのかは考えもの
