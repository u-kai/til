...
- ますの数よりも大きい入力値は受け付けないコードを関数としてきりだしたい
- ただしよく見てみると．．．
...
- 入力値の評価ロジックが最初に main と tik_tok_toe を切り出したときにうまく切り出していない可能性がある
- main だけの場合は，このロジックによって不正な入力を検知したら，再度入力値を受け取ってもらうようなコードに戻るものだったが，今はそうなっていない
- バグがあるかもしれないので，確認する必要がある

---

# バグの確認

- じゃあ，バグを確認する必要があるので，プログラムを実行．．．
- する必要なし
- 僕らには自動テストがある
- テストコードを追記してバグをシミュレーションすることができる
- いちいち実行するよりも低コストかつ，良いテストケースとして残る
